...
| 11 января | Grunt. |
| | Gulp. |
| 31 января | Bootstrap 2. 12-колоночная сетка и поддержка адаптивности. |
| март | Webpack. |
| | Twitter выпускает Bower. Для управления фреймворками и библиотеками, количесво которы резко возрасло. |
